...
const ManageProduct = () => {
  ...
  useEffect(() => {
    fetch(`https://polar-lowlands-60910.herokuapp.com/gallery/products`)
      .then((res) => res.json())
      .then((result) => {
  ...
  const deleteProduct = (id) => {
    ...
    if (result) {
      fetch(
        `https://polar-lowlands-60910.herokuapp.com/gallery/productsr/${id}`,
        {
          method: "DELETE",
          headers: {
  ...
  return (
    <div>
      <h2 className="my-3 color-success">Mange product</h2>
